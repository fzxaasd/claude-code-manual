...
| 0 | 成功/继续 | 所有 Hook |
| 1 | 非阻塞错误 | 所有 Hook |
| 2 | 阻塞错误 | PreToolUse, PostToolUse, Stop, SubagentStop, PreCompact, ConfigChange, TeammateIdle, TaskCreated, TaskCompleted, PermissionRequest*, ElicitationResult* |

**注意**: `PermissionRequest` 和 `ElicitationResult` 可通过 JSON 响应阻止操作。
